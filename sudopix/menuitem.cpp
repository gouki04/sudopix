...
void hgeGUIMenuItem::Enter()
{
	...
	scolor2.SetHWColor(0x00FFA200);
	tcolor2.SetHWColor(0xFFFFA200);
...
void hgeGUIMenuItem::Leave()
{
	...
	scolor2.SetHWColor(0xFFFFA200);
	tcolor2.SetHWColor(0x00FFA200);
	dcolor2=tcolor2-scolor2;
